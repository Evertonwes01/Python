...
sql_insert = text("insert into user values(2,'Maria','email@gmail.com','Ma')")
...
result = connection.execute(sql)     # execute() >> Só foi possivel usar dentro de uma conexão com o banco
for row in result:
    print(row)                      # Retornando resulta das informações da tabela user
